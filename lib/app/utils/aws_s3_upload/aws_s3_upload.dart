...
import 'package:fskeleton/app/utils/aws_s3_upload/src/policy.dart';
import 'package:fskeleton/app/utils/aws_s3_upload/src/utils.dart';
...
class AwsS3 {
  late final String? unusedVariable;
  ...
  static Map<String, String> _convertMetadataToParams(
    ...
    final Map<String, String> updatedMetadata = {};
